    ...
    [
        {
            ...
            text: "Tweetweaver interacts with Twitter's API to leverage the open features of it. Authorize via Twitter using Auth0 with tiered paid subscription levels and a free trial period via Stripe. Schedule tweets for specific and let an Azure logic app tweet them on your behalf. Publish tweets directly from the beautiful editor and construct long threads with ease.",
    ...
    [
        {
            ...
            text: "RecipeLab is a recipe sharing platform that allows anyone to share and store their/others recipes online. Recipes are posted daily and can be up voted and commented and saved to your recipe book, so you never lose a recipe again. You can also search through all recipes posted and show/update your own profile.",
    ...
    [
        {
            ...
            text: "Led the setup and rebuild of ESPN footytips front end. We are working to the current designs and then upgrade in the off season. I also made the decision to build a UI library for them for use site wide eventually using Storybook.  ",
        ...
        },
        {
            ...
            text: "Built the loan application flow for complex forms for a finanicial services company in which brokers can make loan applications on behalf of clients. Upgraded the codebase to Typescript and also upgrading current features.",
    ...
    [
        {
            ...
            text: "Worked in a team creating highly reusable forms for Auspost and their clients. We built an UI library to be reused over around 10+ forms for varying clients.",
        ...
        },
        {
            ...
            text: "Vault is a digital card provider who offer multiple services to clients. I built a reusable activation page in which they can activate a card depending on which client. A client can customize the page with their own requirements. Also did some work on the backend system which handles the card transactions.",
    ...
    [
        {
            ...
            text: "Worked in a team creating a flutter application for a fantasy horse betting company. You are able to enter competitions at a fee and win a prize from a pool of competitors by selecting suite of horses you think will win. I was learning flutter on the job and built out some screens at the same time.",
